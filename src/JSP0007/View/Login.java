...
public class Login extends javax.swing.JFrame {
    ...
    public static ArrayList<Account> a = new ArrayList<>();
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        for (int i = 0; i < a.size(); i++) {
            if (login.equalsIgnoreCase(a.get(i).getLogin())) {
                if (pass.equalsIgnoreCase(a.get(i).getPass())) {
                    Server s = new Server(i,login);
                    s.setVisible(true);
                    lbCheck.setText("");
                    txtLogin.setText("");
                    txtPass.setText("");
                    ...
                    lbCheck.setText("Wrong Password, try again!");
                    return;
                }
            }
            lbCheck.setText("Login name doesn't exist!");
